...
contextBridge.exposeInMainWorld('aneti', {
  ...
  settingsUpdateIntegration: (patch: { apiEnabled?: boolean; apiPort?: number }) =>
    ipcRenderer.invoke('settings:integration', patch),
  ...
  updateStart: () => ipcRenderer.invoke('system:update'),
  updateStatus: () => ipcRenderer.invoke('system:update-status'),
